...
class BlogAdapter(
...
) : ListAdapter<Recipe, BlogAdapter.RecipeViewHolder>(RecipeDiffCallback()) {
    ...
    inner class RecipeViewHolder(private val binding: ItemRecipeBinding) :
        ...
        fun bind(recipe: Recipe) {
            ...
            // Show first few characters of ingredients as preview
            ...
            // Show save button for community recipes
